...
if __name__ == "__main__":
    ...
    latent_path = os.path.join(export_folder, 'neutral_conditions.json')
    ...
    # delete the style related input
    ...
    # output_names = ['output']
    input_tuple = (x_start, torch.tensor([0]*1), cond['past_motion'], cond['traj_pose'], cond['traj_trans'])
    input_names = ['input_x', 'time_steps', 'past_motion', 'traj_pose', 'traj_trans'] 
    output_names = ['output']
