...
def load_pretrained(model: nn.Module, params):
...
if __name__ == '__main__':
    # first step is to load pre-trained models: style encoder, mlp and content encoder; 
    # past motion processor and future motion processor for motion encoder;
    # trajectory transfer and pose processor for trajector encoder; 
    # We only need to train seqPose encoder, output processor during stylization
